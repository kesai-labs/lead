...
In order to inspect the pickle data conveniently on VSCode, we recommend [vscode-pydata-viewer](https://marketplace.visualstudio.com/items?itemName=Percy.vscode-pydata-viewer) and this script [3rd_party/vscode_pydata_viewer/view_pickles.py](https://github.com/kesai-labs/lead/blob/main/3rd_party/vscode_pydata_viewer/view_pickles.py). Those two combined allow us to inspect pickle files directly in VSCode
